...
-- 1. Cleanup tables if starting fresh (Optional, uncomment if database reset is desired)
...
-- 3. Seed default admin (username: admin123, password: password123)
INSERT INTO public.admins (username, password)
VALUES ('admin123', 'password123')
ON CONFLICT (username) DO NOTHING;

-- Seed a default wedding event for testing (host_username: wedding123, host_password: password123)
...
-- 5. Create Permissive Public Policies for Prototype Access
-- Standard setup for prototype clients using Anon public key key-bound access
